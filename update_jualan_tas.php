<?php
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM tas WHERE id_produk = $id_tas";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_tas = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_tas["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_tas["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_tas["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_tas["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_tas["keterangan_produk"];
  }
?>
