<?php
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM sepatu WHERE id_produk = $id_sepatu";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_sepatu = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_sepatu["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_sepatu["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_sepatu["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_sepatu["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_sepatu["keterangan_produk"];
  }
?>
