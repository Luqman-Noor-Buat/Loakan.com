<?php
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM otomotif WHERE id_produk = $id_otomotif";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_otomotif = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_otomotif["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_otomotif["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_otomotif["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_otomotif["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_otomotif["keterangan_produk"];
  }
?>
