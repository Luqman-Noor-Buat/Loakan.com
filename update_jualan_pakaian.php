<?php
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM pakaian WHERE id_produk = $id_pakaian";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_pakaian = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_pakaian["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_pakaian["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_pakaian["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_pakaian["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_pakaian["keterangan_produk"];
  }
?>
