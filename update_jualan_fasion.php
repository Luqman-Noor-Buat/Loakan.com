<?php
  ...
  if(isset($_POST["submit"])) {
    ...
    $query = "UPDATE fasion SET
              id_user = $id_user, 
              foto_produk = '$foto_produk', 
              nama_produk = '$nama_produk', 
              harga_produk = '$harga_produk', 
              keterangan_produk = '$keterangan_produk'
              WHERE id_produk = $id_fasion";
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM fasion WHERE id_produk = $id_fasion";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_fasion = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_fasion["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_fasion["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_fasion["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_fasion["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_fasion["keterangan_produk"];
  }
?>
