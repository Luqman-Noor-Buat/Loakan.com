...
<html lang="en">
  ...
  <body style="background-color: rgba(188, 227, 243)">
    ...
    <div class="container mt-5 text-center">
      <h3>Ingin menambahkan jualan atau memperbarui penjualan?</h3>
      <div class="mt-5">
        <a href="edit-jualan.php" style="text-decoration: none">
          <button type="button" class="btn btn-danger"><strong>Mengedit Penjualan</strong></button>
        </a>
        <a href="tambah-jualan.php" style="text-decoration: none">
          <button type="button" class="btn btn-success"><strong>Menambah Penjualan</strong></button>
        </a>
      </div>
    </div>
    <p class="mt-5"></p>
