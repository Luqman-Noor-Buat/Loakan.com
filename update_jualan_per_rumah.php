<?php
  ...
  if(isset($_POST["submit"])) {
    ...
    $query = "UPDATE per_rumah SET
              id_user = $id_user, 
              foto_produk = '$foto_produk', 
              nama_produk = '$nama_produk', 
              harga_produk = '$harga_produk', 
              keterangan_produk = '$keterangan_produk'
              WHERE id_produk = $id_per_rumah";
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM per_rumah WHERE id_produk = $id_per_rumah";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_per_rumah = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_per_rumah["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_per_rumah["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_per_rumah["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_per_rumah["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_per_rumah["keterangan_produk"];
  }
?>
    ...
    <div class="container mt-5 text-center" style="background-color: rgb(113, 213, 253); border-radius: 10px">
      ...
      <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-outline text-start mb-5">
          ...
          <textarea class="form-control input-color" id="keterangan_produk" placeholder="Masukkan mengenai keterangan produk anda" name="keterangan_produk" required rows="4"><?php echo $_SESSION['keterangan_produk'] ?></textarea>
        </div>
