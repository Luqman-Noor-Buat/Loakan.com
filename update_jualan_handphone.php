<?php
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM handphone WHERE id_produk = $id_handphone";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_handphone = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_handphone["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_handphone["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_handphone["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_handphone["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_handphone["keterangan_produk"];
  }
?>
