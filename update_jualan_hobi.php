<?php
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM hobi WHERE id_produk = $id_hobi";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_hobi = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_hobi["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_hobi["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_hobi["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_hobi["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_hobi["keterangan_produk"];
  }
?>
