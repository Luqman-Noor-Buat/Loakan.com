<?php
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM komputer WHERE id_produk = $id_komputer";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_komputer = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_komputer["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_komputer["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_komputer["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_komputer["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_komputer["keterangan_produk"];
  }
?>
