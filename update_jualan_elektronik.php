<?php
  ...
  //TAMPIL DATA
  $query1 = "SELECT * FROM elektronik WHERE id_produk = $id_elektronik";
  $result1 = mysqli_query($conn, $query1);
  if(mysqli_num_rows($result1) > 0){
    $data_jualan_elektronik = mysqli_fetch_array($result1);
    $_SESSION["id_user"] = $data_jualan_elektronik["id_user"];
    $_SESSION["foto_produk"] = $data_jualan_elektronik["foto_produk"];
    $_SESSION["nama_produk"] = $data_jualan_elektronik["nama_produk"];
    $_SESSION["harga_produk"] = $data_jualan_elektronik["harga_produk"];
    $_SESSION["keterangan_produk"] = $data_jualan_elektronik["keterangan_produk"];
  }
?>
